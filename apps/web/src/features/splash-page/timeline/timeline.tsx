      ...
      >
        ...
        <div className="relative">
          ...
          >
            <div className="flex items-center gap-3">
              <div
                className="w-3 h-3 rounded-full bg-emerald-500 dark:bg-emerald-400 shadow-lg shadow-emerald-500/30 ring-2 ring-emerald-200/50 dark:ring-emerald-800/50"
                aria-hidden="true"
              />
            ...
            <div className="flex items-center gap-3">
              <div
                className="w-3 h-3 rounded-full bg-amber-500 dark:bg-amber-400 shadow-lg shadow-amber-500/30 ring-2 ring-amber-200/50 dark:ring-amber-800/50"
                aria-hidden="true"
              />
            ...
            <div className="flex items-center gap-3">
              <div
                className="w-3 h-3 rounded-full bg-muted-foreground shadow-lg shadow-muted-foreground/30 ring-2 ring-muted/50"
                aria-hidden="true"
              />
